          ...
          <div className="flex flex-col gap-4 ">
            ...
            <form onSubmit={handleSignIn} className=" flex flex-col gap-4">
              <input
                ...
                className="border-gray-300 focus:outline-none focus:border-blue-500 border-2 p-3 rounded-lg"
                type="text"
                placeholder="Email"
              />
              <input
              ...
              />
              <button className=" text-white cursor-pointer p-3 rounded-lg bg-blue-500">
                Sign In
              </button>
            </form>
            <div className="flex flex-col gap-4">
